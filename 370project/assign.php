                    ...
                    <form action="process/assignp.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row row-space">
                            <div class="col-2 row-2">
                                <div class="input-group">waktu mulai
                                    <input class="input--style-1" type="time" placeholder="time" name="waktu1" required="required">
                        ...
                        <div class="row row-space">
                            <div class="col-2 row-2">
                                <div class="input-group">waktu selesai
                                    <input class="input--style-1" type="time" placeholder="time" name="waktu2" required="required">
